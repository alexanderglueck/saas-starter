            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id="payment-form" action="{{ route('subscription.store') }}"
                              method="POST">
                            @csrf
                            ...
                            <x-inputs.input name="card-holder-name" label="Card holder name" id="card-holder-name"
